...
from nbconvert import exceptions
...
@pytest.mark.parametrize(
    ...
    [
        (
            exceptions.NBConvertExecutionError,
            (1, 2, "TestSource", "Exception", Exception(), ["Traceback", "Message"]),
        ),
        (exceptions.NBConvertMissingParameterException, ("NBConvertMissingParameterException",)),
        (exceptions.AwsError, ("AwsError",)),
        (exceptions.FileExistsError, ("FileExistsError",)),
        (exceptions.NBConvertlException, ("NBConvertlException",)),
        (exceptions.NBConvertRateLimitException, ("NBConvertRateLimitException",)),
        (
            exceptions.NBConvertOptionalDependencyException,
            ("NBConvertOptionalDependencyException",),
        ),
    ],
)
